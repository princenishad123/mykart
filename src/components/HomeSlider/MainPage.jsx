  ...
  return (
    <div className="w-full  flex items-center justify-center gap-4 max-sm:flex-col max-sm:justify-between max-sm:relative bg-slate-100 ">
      <div className="w-1/2  max-sm:h-auto max-sm:text-center px-16 max-sm:px-1   max-sm:w-full z-10">
        <h1
          data-aos="fade-right"
          className="text-8xl max-lg:text-7xl max-md:text-6xl font-semibold text-gray-700 max-sm:leading-tight max-sm:hidden "
        >
          Let's <br /> Explore <br />
        ...
        <h1
          data-aos="fade-right"
          className="text-8xl max-lg:text-7xl max-md:text-6xl max-sm:py-4 max-sm:text-4xl max-sm:pt-12 font-semibold text-gray-700 max-sm:leading-tight sm:hidden"
        >
          Let's Explore
        ...
        <h1
          data-aos="fade-right"
          className="text-3xl text-gray-700 px-3 font-semibold my-7 sm:hidden"
        >
